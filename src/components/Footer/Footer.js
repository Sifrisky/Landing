  ...
  render() {
    return (
      <div>
        ...
        <div className="section teal darken-2 white-text center">
        <div className="row">
            <div className="col s12">
              <h4>Siguenos</h4>
              <p>Chequea nuestras ofertas en nuestras redes sociales.</p>
              ...
              <Link to="htttps://instagram.com" target="_blank" className="white-text">
